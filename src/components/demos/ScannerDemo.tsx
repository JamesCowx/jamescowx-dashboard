    ...
    <div className="liquid-glass rounded-2xl p-6 space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-7 h-7 rounded-lg bg-[#f87171]/15 flex items-center justify-center text-sm">🛡</div>
          <div>
            <h3 className="text-sm font-semibold">PacketGuard</h3>
            <div className="text-[10px] text-[var(--color-text-muted)]">Network Scanner · Target: 192.168.1.0/24</div>
          </div>
        </div>
