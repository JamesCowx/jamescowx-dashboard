      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[10px] text-[var(--color-text-muted)]">Pipeline #8472 · main · 8 suites</div>
          </div>
        </div>
      ...
      {showFailures && (
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => setShowFailures(false)} className="text-[10px] text-[var(--color-text-muted)] cursor-pointer">✕</button>
          </div>
