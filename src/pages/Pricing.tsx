...
const tiers = [
  ...
  },
  {
    ...
    cta: 'Choose Standard',
    popular: true,
    gradient: 'from-blue-400/30 to-purple-500/20',
  },
  {
    name: 'Pro',
    price: 5999,
              ...
              {steps.map((s, i) => (
                <SlideUp key={s.step} delay={i * 0.1}>
                  ...
                  >
                    ...
                    >
                      <svg className="w-4 h-4 text-[var(--color-accent-blue)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                        <path d={s.icon} />
                      </svg>
                    </motion.div>
